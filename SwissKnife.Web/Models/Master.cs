...
namespace SwissKnife.Web.Models
{
    ...
    {
        private static readonly Dictionary<int, string> _prefectures = new Dictionary<int, string>
        {
            { 1, "北海道" },
            { 2, "青森県" },
            { 3, "岩手県" },
        ...
        private static readonly IDictionary<int, string> _colors = new Dictionary<int, string>
        {
            { 1, "赤色" },
            { 2, "青色" },
            { 3, "緑色" }
        ...
        private static readonly IEnumerable<SelectListItem> _prefectureList = _prefectures.ToSelectList();
